      ...
      <div className='border-l border-solid border-gray-500 bg-gray-100 w-full'>
         <div className="flex min-h-full flex-1 flex-col justify-center">
            ...
            <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
                  ...
                  <div>
                     ...
                     <div className="mt-2">
                        <input
                           ...
                           autoComplete="email"
                           required
                           className="block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-700 sm:text-sm sm:leading-6"
                        />
                     </div>
                  </div>
               ...
               <p className="mt-10 text-center text-sm text-gray-500 flex items-center justify-center gap-2">
